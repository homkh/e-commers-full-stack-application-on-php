...
<html lang="en">
  ...
  <body>
    ...
    <nav>
      <div class="bg-light">
        <h2 class="text-center mt-3">Agro Store Nepal</h2>
    ...
    <div class="row px-1 mt-3">
      <div class="col-md-10">
        ...
        <div class="row">
            <!-- <div class="col-md-4">
                <div class='card'>
                        <img src='./image/rice.jpg' class='card-img-top' alt='$product_title'>
                        <div class='card-body'>
            ...
            <div class="col-md-8">
                <div class="row">
                    <div class="col-md-12">
                        <h4 class="text text-center text-info mb-5">Relaed Product Informatiosn</h4>
                        <div class="col-md-6">
                        <img src='./image/rice.jpg' class='card-img-top' alt='$product_title'>
                        </div>
                        <div class="col-md-6">
                            <p>This products hase been provides the qualoty of te seeds which alsooccures the many prodiucts nformations and others detsils.</p>
                        </div>
                    </div>
                                  ...
                                  echo "<div class='col-md-4 mb-3'>
                                      ...
                                      <div class='row'>
                                          <div class='col-md-12'>
                                              ...
                                              <div class='col-md-5' style='color:#F86F03; text-align: justify;'>
